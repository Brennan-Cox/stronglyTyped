...
PostgreSQL is used for the datbase, Next.js with TypeScript and TailwindCSS is used for the front-end and other application functionality.
...
```
cd existing_repo
git remote add origin https://gitlab.com/ru-itec/tlewis-williams/f22-370/team01/dev_prj.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ru-itec/tlewis-williams/f22-370/team01/dev_prj/-/settings/integrations)
