...
function StandardTab(props: any) {
       ...
       var [displayArr, SetElementArr] = useState(elementArr) //useState(props.initialText)
        ...
        <div className="flex justify-between">
            ...
            <div className="flex justify-center mt-20 bg-mint rounded-3xl w-1/3">
                <div className="text-lg">
                    ...
                    <br/>
                    <button onClick={() => setInitialText()} className = "text-white bg-stgray-200 rounded-md mt-5 pr-2 pl-2"><a href={"/standard/"+props.test.id}>Reset Test</a></button>
                    <br/>
